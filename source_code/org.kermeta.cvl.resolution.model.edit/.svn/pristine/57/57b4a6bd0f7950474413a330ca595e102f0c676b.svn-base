...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.resolution.ChoiceResolution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceResolutionItemProvider
	 ...
	 * @generated
	 */
	public ChoiceResolutionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChoiceResolution_decision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChoiceResolution_decision_feature", "_UI_ChoiceResolution_type"),
				 ResolutionPackage.Literals.CHOICE_RESOLUTION__DECISION,
				 true,
				 false,
				 false,
	...
	protected void addResolvedChoicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChoiceResolution_resolvedChoice_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChoiceResolution_resolvedChoice_feature", "_UI_ChoiceResolution_type"),
				 ResolutionPackage.Literals.CHOICE_RESOLUTION__RESOLVED_CHOICE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ChoiceResolution.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChoiceResolution"));
	}
	...
	public String getText(Object object) {
		String label = ((ChoiceResolution)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ChoiceResolution_type") :
			getString("_UI_ChoiceResolution_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChoiceResolution.class)) {
