...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.resolution.VInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VInstanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ResolutionPackage.Literals.VINSTANCE__TYPE,
				 true,
				 false,
				 true,
				 null,
