...
import spem.provider.ActivityItemProvider;
import spem.provider.Spem2EditPlugin;

import spem.uma.UmaFactory;
import spem.uma.UmaPackage;

/**
 * This is the item provider adapter for a {@link spem.uma.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider
	...
	public String getText(Object object) {
		String label = ((spem.uma.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(spem.uma.Process.class)) {
