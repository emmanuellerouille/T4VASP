...
/**
 * This is the item provider adapter for a {@link spem.TaskDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAlternativePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskDefinition_alternative_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskDefinition_alternative_feature", "_UI_TaskDefinition_type"),
				 SpemPackage.Literals.TASK_DEFINITION__ALTERNATIVE,
				 true,
				 false,
				 true,
				 null,
