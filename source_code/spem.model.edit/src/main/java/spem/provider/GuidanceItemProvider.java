...
/**
 * This is the item provider adapter for a {@link spem.Guidance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guidance_attachment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guidance_attachment_feature", "_UI_Guidance_type"),
				 SpemPackage.Literals.GUIDANCE__ATTACHMENT,
				 true,
				 false,
				 false,
