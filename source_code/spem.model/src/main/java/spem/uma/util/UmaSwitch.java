...
public class UmaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UmaPackage.CATEGORY_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(categoryPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case UmaPackage.PROCESS: {
				spem.uma.Process process = (spem.uma.Process)theEObject;
			...
			case UmaPackage.ROLE_DEFINITION_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(roleDefinitionPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.TASK_DEFINITION_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(taskDefinitionPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.WORK_PRODUCT_DEFINITION_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(workProductDefinitionPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.GUIDANCE_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(guidancePackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.DISCIPLINE_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(disciplinePackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.DOMAIN_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(domainPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.WORK_PRODUCT_KIND_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(workProductKindPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.ROLE_SET_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(roleSetPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.TOOL_DEFINITION_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(toolDefinitionPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.CONFIGURATION_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(configurationPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case UmaPackage.QUALIFICATION_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(qualificationPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseProcess(spem.uma.Process object) {
		return null;
	}
