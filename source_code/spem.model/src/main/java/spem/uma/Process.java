 ...
 * <ul>
 *   <li>{@link spem.uma.Process#getIncludedPattern <em>Included Pattern</em>}</li>
 *   <li>{@link spem.uma.Process#getScope <em>Scope</em>}</li>
 *   <li>{@link spem.uma.Process#getUsageNote <em>Usage Note</em>}</li>
 *   <li>{@link spem.uma.Process#getIncludedConnector <em>Included Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @see spem.uma.UmaPackage#getProcess()
 * @model
 * @generated
 */
public interface Process extends Activity {
	 ...
	 * The list contents are of type {@link spem.uma.CapabilityPattern}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see spem.uma.UmaPackage#getProcess_IncludedPattern()
	 ...
	 * @see #setScope(String)
	 * @see spem.uma.UmaPackage#getProcess_Scope()
	 * @model
	 * @generated
	 */
	String getScope();
	...
	/**
	 * Sets the value of the '{@link spem.uma.Process#getScope <em>Scope</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see spem.uma.UmaPackage#getProcess_UsageNote()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link spem.WorkProductPortConnector}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see spem.uma.UmaPackage#getProcess_IncludedConnector()
	 * @model containment="true"
	 * @generated
	 */
