 ...
 * <ul>
 *   <li>{@link spem.uma.impl.PracticeImpl#getSubPractice <em>Sub Practice</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getReferencedActivity <em>Referenced Activity</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getContentReference <em>Content Reference</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getAdditionalInfo <em>Additional Info</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getGoal <em>Goal</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getLevelOfAdoption <em>Level Of Adoption</em>}</li>
 *   <li>{@link spem.uma.impl.PracticeImpl#getProblem <em>Problem</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
