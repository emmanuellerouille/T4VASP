...
public class SpemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SpemPackage.METRIC: {
				...
				if (result == null) result = caseGuidance(metric);
				if (result == null) result = caseMethodContentElement(metric);
				if (result == null) result = caseDescribableElement(metric);
				if (result == null) result = caseMethodContentPackageableElement(metric);
				if (result == null) result = caseExtensibleElement(metric);
				if (result == null) result = caseVariabilityElement(metric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpemPackage.METHOD_CONTENT_PACKAGEABLE_ELEMENT: {
				...
				if (result == null) result = caseVariabilityElement(methodContentPackageableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpemPackage.METHOD_CONTENT_PACKAGE: {
				...
				if (result == null) result = caseVariabilityElement(methodContentPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpemPackage.LIFE_CYCLE_SPECIFICATION: {
				LifeCycleSpecification lifeCycleSpecification = (LifeCycleSpecification)theEObject;
				T result = caseLifeCycleSpecification(lifeCycleSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Life Cycle Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Life Cycle Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLifeCycleSpecification(LifeCycleSpecification object) {
		return null;
	}
