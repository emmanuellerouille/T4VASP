...
import spem.CompositeRole;
import spem.Default_ResponsibilityAssignment;
import spem.Default_TaskDefinitionParameter;
import spem.Default_TaskDefinitionPerformer;
...
import spem.ProcessResponsibilityAssignment;
...
import spem.WorkDefinitionPerformer;
import spem.WorkProductDefinition;
import spem.WorkProductDefinitionRelationship;
import spem.WorkProductKind;
import spem.WorkProductPort;
import spem.WorkProductPortConnector;
import spem.WorkProductUse;
import spem.WorkProductUseRelationship;
import spem.WorkSequence;
import spem.WorkSequenceKind;

import spem.uma.UmaPackage;

import spem.uma.impl.UmaPackageImpl;
...
public class SpemPackageImpl extends EPackageImpl implements SpemPackage {
	 ...
	 * @generated
	 */
	private EClass lifeCycleSpecificationEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getWorkDefinitionParameter_Name() {
	...
	public EAttribute getWorkDefinitionParameter_Direction() {
		return (EAttribute)workDefinitionParameterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWorkDefinitionParameter_Optionality() {
		return (EAttribute)workDefinitionParameterEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getWorkDefinitionParameter_ParameterType() {
		return (EReference)workDefinitionParameterEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getBreakdownElement_UsageGuidance() {
		return (EReference)breakdownElementEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getActivity_Alternatives() {
	 ...
	 * @generated
	 */
	public EAttribute getActivity_HowToStaff() {
	 ...
	 * @generated
	 */
	public EReference getWorkProductUse_LifeCycle() {
		return (EReference)workProductUseEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getDescribableElement_PresentedAfter() {
	 ...
	 * @generated
	 */
	public EReference getDescribableElement_PresentedBefore() {
		return (EReference)describableElementEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getDescribableElement_KeyConsideration() {
		return (EReference)describableElementEClass.getEStructuralFeatures().get(8);
	}
	...
	public EReference getDescribableElement_Category() {
		return (EReference)describableElementEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EAttribute getGuidance_Attachment() {
	 ...
	 * @generated
	 */
	public EReference getMethodContentElement_SuppressedMethodContentElement() {
	...
	public EReference getMethodContentElement_MethodContentKind() {
		return (EReference)methodContentElementEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMethodContentElement_Copyright() {
		return (EAttribute)methodContentElementEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMethodContentElement_Author() {
		return (EAttribute)methodContentElementEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMethodContentElement_ChangeDate() {
		return (EAttribute)methodContentElementEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMethodContentElement_ChangeDescription() {
		return (EAttribute)methodContentElementEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMethodContentElement_Version() {
		return (EAttribute)methodContentElementEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getToolDefinition_ToolMentor() {
	 ...
	 * @generated
	 */
	public EReference getTaskDefinition_Alternative() {
	 ...
	 * @generated
	 */
	public EReference getWorkProductDefinition_EstimatingConsideration() {
	 ...
	 * @generated
	 */
	public EReference getWorkProductDefinition_Report() {
	 ...
	 * @generated
	 */
	public EReference getWorkProductDefinition_Template() {
	 ...
	 * @generated
	 */
	public EReference getWorkProductDefinition_ToolMentor() {
		return (EReference)workProductDefinitionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWorkProductDefinition_ImpactOfNotHaving() {
		return (EAttribute)workProductDefinitionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWorkProductDefinition_ReasonForNotNeeding() {
		return (EAttribute)workProductDefinitionEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getRoleDefinition_RequiredQualification() {
	...
	public EAttribute getTaskUse_PreCondition() {
		return (EAttribute)taskUseEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getProcessComponent_Author() {
	...
	public EReference getMethodConfiguration_ProcessView() {
		return (EReference)methodConfigurationEClass.getEStructuralFeatures().get(7);
	}
	...
	public EAttribute getMethodPlugin_Supporting() {
		return (EAttribute)methodPluginEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getMethodPlugin_OwnedProcessPackage() {
		return (EReference)methodPluginEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getMethodPlugin_BasePlugin() {
		return (EReference)methodPluginEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getMethodPlugin_ReferencedMethodPlugin() {
		return (EReference)methodPluginEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getMethodLibrary_Tool() {
	...
	public EReference getMethodLibrary_ConfigurationPackage() {
		return (EReference)methodLibraryEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getMethodLibrary_Any() {
		return (EReference)methodLibraryEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EClass getLifeCycleSpecification() {
		return lifeCycleSpecificationEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(workDefinitionParameterEClass, WORK_DEFINITION_PARAMETER__NAME);
		createEAttribute(workDefinitionParameterEClass, WORK_DEFINITION_PARAMETER__DIRECTION);
		createEAttribute(workDefinitionParameterEClass, WORK_DEFINITION_PARAMETER__OPTIONALITY);
		createEReference(workDefinitionParameterEClass, WORK_DEFINITION_PARAMETER__PARAMETER_TYPE);
		...
		createEReference(breakdownElementEClass, BREAKDOWN_ELEMENT__USAGE_GUIDANCE);
		...
		createEReference(activityEClass, ACTIVITY__ALTERNATIVES);
		createEAttribute(activityEClass, ACTIVITY__HOW_TO_STAFF);
		...
		createEReference(workProductUseEClass, WORK_PRODUCT_USE__LIFE_CYCLE);
		...
		createEReference(describableElementEClass, DESCRIBABLE_ELEMENT__PRESENTED_AFTER);
		createEReference(describableElementEClass, DESCRIBABLE_ELEMENT__PRESENTED_BEFORE);
		createEReference(describableElementEClass, DESCRIBABLE_ELEMENT__KEY_CONSIDERATION);
		...
		createEAttribute(guidanceEClass, GUIDANCE__ATTACHMENT);

		metricEClass = createEClass(METRIC);
		createEAttribute(metricEClass, METRIC__EXPRESSION);

		methodContentElementEClass = createEClass(METHOD_CONTENT_ELEMENT);
		createEReference(methodContentElementEClass, METHOD_CONTENT_ELEMENT__SUPPRESSED_METHOD_CONTENT_ELEMENT);
		createEReference(methodContentElementEClass, METHOD_CONTENT_ELEMENT__METHOD_CONTENT_KIND);
		createEAttribute(methodContentElementEClass, METHOD_CONTENT_ELEMENT__COPYRIGHT);
		createEAttribute(methodContentElementEClass, METHOD_CONTENT_ELEMENT__AUTHOR);
		createEAttribute(methodContentElementEClass, METHOD_CONTENT_ELEMENT__CHANGE_DATE);
		createEAttribute(methodContentElementEClass, METHOD_CONTENT_ELEMENT__CHANGE_DESCRIPTION);
		createEAttribute(methodContentElementEClass, METHOD_CONTENT_ELEMENT__VERSION);
		...
		createEReference(toolDefinitionEClass, TOOL_DEFINITION__TOOL_MENTOR);
		...
		createEReference(taskDefinitionEClass, TASK_DEFINITION__ALTERNATIVE);
		...
		createEReference(workProductDefinitionEClass, WORK_PRODUCT_DEFINITION__ESTIMATING_CONSIDERATION);
		createEReference(workProductDefinitionEClass, WORK_PRODUCT_DEFINITION__REPORT);
		createEReference(workProductDefinitionEClass, WORK_PRODUCT_DEFINITION__TEMPLATE);
		createEReference(workProductDefinitionEClass, WORK_PRODUCT_DEFINITION__TOOL_MENTOR);
		createEAttribute(workProductDefinitionEClass, WORK_PRODUCT_DEFINITION__IMPACT_OF_NOT_HAVING);
		createEAttribute(workProductDefinitionEClass, WORK_PRODUCT_DEFINITION__REASON_FOR_NOT_NEEDING);

		roleDefinitionEClass = createEClass(ROLE_DEFINITION);
		createEAttribute(roleDefinitionEClass, ROLE_DEFINITION__SYNONYM);
		createEReference(roleDefinitionEClass, ROLE_DEFINITION__REQUIRED_QUALIFICATION);
		...
		createEAttribute(processComponentEClass, PROCESS_COMPONENT__AUTHOR);
		...
		createEReference(methodConfigurationEClass, METHOD_CONFIGURATION__ADDED_CATEGORY);
		...
		createEReference(methodPluginEClass, METHOD_PLUGIN__REFERENCED_METHOD_PLUGIN);
		...
		createEReference(methodLibraryEClass, METHOD_LIBRARY__TOOL);
		createEReference(methodLibraryEClass, METHOD_LIBRARY__CONFIGURATION_PACKAGE);
		createEReference(methodLibraryEClass, METHOD_LIBRARY__ANY);
		...
		lifeCycleSpecificationEClass = createEClass(LIFE_CYCLE_SPECIFICATION);
	...
	public void initializePackageContents() {
		...
		metricEClass.getESuperTypes().add(this.getGuidance());
		...
		methodContentPackageableElementEClass.getESuperTypes().add(this.getVariabilityElement());
		...
		workProductKindEClass.getESuperTypes().add(this.getMethodContentKind());
		...
		initEAttribute(getWorkDefinitionParameter_Name(), ecorePackage.getEString(), "name", null, 0, 1, WorkDefinitionParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWorkDefinitionParameter_Optionality(), this.getOptionalityKind(), "optionality", null, 0, 1, WorkDefinitionParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWorkDefinitionParameter_ParameterType(), this.getWorkProductDefinition(), null, "parameterType", null, 0, 1, WorkDefinitionParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBreakdownElement_UsageGuidance(), this.getGuidance(), null, "usageGuidance", null, 0, 1, BreakdownElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWorkSequence_LinkKind(), this.getWorkSequenceKind(), "linkKind", "finishToStart", 1, 1, WorkSequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getActivity_Alternatives(), this.getActivity(), null, "alternatives", null, 0, -1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivity_HowToStaff(), ecorePackage.getEString(), "howToStaff", null, 0, 1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWorkProductUse_LifeCycle(), this.getLifeCycleSpecification(), null, "lifeCycle", null, 0, 1, WorkProductUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDescribableElement_PresentedAfter(), this.getDescribableElement(), null, "presentedAfter", null, 0, 1, DescribableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDescribableElement_PresentedBefore(), this.getDescribableElement(), null, "presentedBefore", null, 0, 1, DescribableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDescribableElement_KeyConsideration(), theUmaPackage.getEstimatingConsideration(), null, "keyConsideration", null, 0, -1, DescribableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDescribableElement_Category(), this.getCategory(), null, "category", null, 0, -1, DescribableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGuidance_Attachment(), ecorePackage.getEString(), "attachment", null, 0, -1, Guidance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethodContentElement_SuppressedMethodContentElement(), this.getMethodContentElement(), null, "suppressedMethodContentElement", null, 0, -1, MethodContentElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMethodContentElement_Copyright(), ecorePackage.getEString(), "copyright", null, 0, 1, MethodContentElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethodContentElement_Author(), ecorePackage.getEString(), "author", null, 0, -1, MethodContentElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethodContentElement_ChangeDate(), ecorePackage.getEDate(), "changeDate", null, 0, 1, MethodContentElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethodContentElement_ChangeDescription(), ecorePackage.getEString(), "changeDescription", null, 0, 1, MethodContentElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethodContentElement_Version(), ecorePackage.getEString(), "version", null, 0, 1, MethodContentElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getToolDefinition_ToolMentor(), theUmaPackage.getToolMentor(), null, "toolMentor", null, 0, -1, ToolDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTaskDefinition_Alternative(), this.getTaskDefinition(), null, "alternative", null, 0, -1, TaskDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStep_Predecessor(), this.getStep(), null, "predecessor", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWorkProductDefinition_EstimatingConsideration(), theUmaPackage.getEstimatingConsideration(), null, "estimatingConsideration", null, 0, -1, WorkProductDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWorkProductDefinition_Report(), theUmaPackage.getReport(), null, "report", null, 0, -1, WorkProductDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWorkProductDefinition_Template(), theUmaPackage.getTemplate(), null, "template", null, 0, -1, WorkProductDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWorkProductDefinition_ToolMentor(), theUmaPackage.getToolMentor(), null, "toolMentor", null, 0, -1, WorkProductDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWorkProductDefinition_ImpactOfNotHaving(), ecorePackage.getEString(), "impactOfNotHaving", null, 0, 1, WorkProductDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWorkProductDefinition_ReasonForNotNeeding(), ecorePackage.getEString(), "reasonForNotNeeding", null, 0, -1, WorkProductDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRoleDefinition_RequiredQualification(), this.getQualification(), null, "requiredQualification", null, 0, -1, RoleDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProcessComponent_Copyright(), ecorePackage.getEString(), "copyright", null, 0, 1, ProcessComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessComponent_Author(), ecorePackage.getEString(), "author", null, 0, -1, ProcessComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessComponent_Version(), ecorePackage.getEString(), "version", null, 0, 1, ProcessComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessComponent_ChangeDate(), ecorePackage.getEDate(), "changeDate", null, 0, 1, ProcessComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessComponent_ChangeDescription(), ecorePackage.getEString(), "changeDescription", null, 0, 1, ProcessComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethodConfiguration_AddedCategory(), this.getCategory(), null, "addedCategory", null, 0, -1, MethodConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMethodPlugin_UserChangeable(), ecorePackage.getEBoolean(), "userChangeable", null, 0, 1, MethodPlugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethodPlugin_Supporting(), ecorePackage.getEBooleanObject(), "supporting", null, 0, 1, MethodPlugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethodPlugin_ReferencedMethodPlugin(), this.getMethodPlugin(), null, "referencedMethodPlugin", null, 0, -1, MethodPlugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethodLibrary_Tool(), this.getToolDefinition(), null, "tool", null, 0, 1, MethodLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethodLibrary_ConfigurationPackage(), theUmaPackage.getConfigurationPackage(), null, "configurationPackage", null, 0, 1, MethodLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethodLibrary_Any(), ecorePackage.getEObject(), null, "any", null, 0, -1, MethodLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(lifeCycleSpecificationEClass, LifeCycleSpecification.class, "LifeCycleSpecification", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
