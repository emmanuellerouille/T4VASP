 ...
 * <ul>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getBaseConfiguration <em>Base Configuration</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getMethodPluginSelection <em>Method Plugin Selection</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getProcessPackageSelection <em>Process Package Selection</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getContentPackageSelection <em>Content Package Selection</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getAddedCategory <em>Added Category</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getSubstractedCategory <em>Substracted Category</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getDefaultView <em>Default View</em>}</li>
 *   <li>{@link spem.impl.MethodConfigurationImpl#getProcessView <em>Process View</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodConfigurationImpl extends MethodLibraryPackageableElementImpl implements MethodConfiguration {
	 ...
	 * @ordered
	 */
	protected EList<Category> addedCategory;
	 ...
	 * @generated
	 */
	public EList<Category> getAddedCategory() {
		if (addedCategory == null) {
			addedCategory = new EObjectResolvingEList<Category>(Category.class, this, SpemPackage.METHOD_CONFIGURATION__ADDED_CATEGORY);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SpemPackage.METHOD_CONFIGURATION__ADDED_CATEGORY:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SpemPackage.METHOD_CONFIGURATION__ADDED_CATEGORY:
				...
				getAddedCategory().addAll((Collection<? extends Category>)newValue);
				return;
			case SpemPackage.METHOD_CONFIGURATION__SUBSTRACTED_CATEGORY:
