 ...
 * <ul>
 *   <li>{@link spem.impl.BreakdownElementImpl#isHasMultipleOccurrences <em>Has Multiple Occurrences</em>}</li>
 *   <li>{@link spem.impl.BreakdownElementImpl#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link spem.impl.BreakdownElementImpl#isIsPlanned <em>Is Planned</em>}</li>
 *   <li>{@link spem.impl.BreakdownElementImpl#getPlanningData <em>Planning Data</em>}</li>
 *   <li>{@link spem.impl.BreakdownElementImpl#getUsageGuidance <em>Usage Guidance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BreakdownElementImpl extends ProcessElementImpl implements BreakdownElement {
	...
	public Guidance getUsageGuidance() {
		if (usageGuidance != null && usageGuidance.eIsProxy()) {
			...
			if (usageGuidance != oldUsageGuidance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpemPackage.BREAKDOWN_ELEMENT__USAGE_GUIDANCE, oldUsageGuidance, usageGuidance));
			}
		}
	...
	public void setUsageGuidance(Guidance newUsageGuidance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpemPackage.BREAKDOWN_ELEMENT__USAGE_GUIDANCE, oldUsageGuidance, usageGuidance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SpemPackage.BREAKDOWN_ELEMENT__USAGE_GUIDANCE:
