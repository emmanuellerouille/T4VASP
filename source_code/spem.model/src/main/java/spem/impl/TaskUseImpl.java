 ...
 * <ul>
 *   <li>{@link spem.impl.TaskUseImpl#isIsRepeatable <em>Is Repeatable</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#isIsOngoing <em>Is Ongoing</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#isIsEventDriven <em>Is Event Driven</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getLinkToPredecessor <em>Link To Predecessor</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getLinkToSuccessor <em>Link To Successor</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getTask <em>Task</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getOwnedProcessParameter <em>Owned Process Parameter</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getSelectedStep <em>Selected Step</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getPreCondition <em>Pre Condition</em>}</li>
 *   <li>{@link spem.impl.TaskUseImpl#getPostCondition <em>Post Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
