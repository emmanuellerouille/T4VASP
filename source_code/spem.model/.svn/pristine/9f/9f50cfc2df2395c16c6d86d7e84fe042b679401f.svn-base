...
public interface SpemFactory extends EFactory {
	 ...
	 * @generated
	 */
	SpemFactory eINSTANCE = spem.impl.SpemFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Work Product Kind</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Work Product Kind</em>'.
	 * @generated
	 */
	WorkProductKind createWorkProductKind();
