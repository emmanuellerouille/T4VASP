 ...
 * <ul>
 *   <li>{@link spem.impl.WorkProductDefinitionRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link spem.impl.WorkProductDefinitionRelationshipImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
