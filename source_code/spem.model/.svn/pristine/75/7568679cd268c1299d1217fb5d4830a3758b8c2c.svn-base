 ...
 * <ul>
 *   <li>{@link spem.ProcessPerformer#getLinkedRoleUse <em>Linked Role Use</em>}</li>
 *   <li>{@link spem.ProcessPerformer#getLinkedActivity <em>Linked Activity</em>}</li>
 *   <li>{@link spem.ProcessPerformer#getLinkedTaskUse <em>Linked Task Use</em>}</li>
 * </ul>
 * </p>
 *
 * @see spem.SpemPackage#getProcessPerformer()
 * @model
 * @generated
 */
public interface ProcessPerformer extends WorkDefinitionPerformer, BreakdownElement {
	 ...
	 * @see spem.SpemPackage#getProcessPerformer_LinkedRoleUse()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see spem.SpemPackage#getProcessPerformer_LinkedActivity()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link spem.ProcessPerformer#getLinkedActivity <em>Linked Activity</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see spem.SpemPackage#getProcessPerformer_LinkedTaskUse()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link spem.ProcessPerformer#getLinkedTaskUse <em>Linked Task Use</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
