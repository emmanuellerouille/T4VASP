 ...
 * <ul>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getProjectCharacteristics <em>Project Characteristics</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getRiskLevel <em>Risk Level</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getEstimatingTechnique <em>Estimating Technique</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getProjectMemberExpertise <em>Project Member Expertise</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getTypeOfContract <em>Type Of Contract</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getCommunicationMaterial <em>Communication Material</em>}</li>
 *   <li>{@link spem.uma.impl.DeliveryProcessImpl#getEducationalMaterial <em>Educational Material</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
