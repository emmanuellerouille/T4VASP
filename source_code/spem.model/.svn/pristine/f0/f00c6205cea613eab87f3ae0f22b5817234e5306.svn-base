 ...
 * <ul>
 *   <li>{@link spem.uma.Discipline#getRelatedTask <em>Related Task</em>}</li>
 *   <li>{@link spem.uma.Discipline#getRelatedWorflow <em>Related Worflow</em>}</li>
 * </ul>
 * </p>
 *
 * @see spem.uma.UmaPackage#getDiscipline()
 * @model
 * @generated
 */
public interface Discipline extends Category {
	 ...
	 * @see spem.uma.UmaPackage#getDiscipline_RelatedTask()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link spem.uma.Process}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see spem.uma.UmaPackage#getDiscipline_RelatedWorflow()
	 * @model
	 * @generated
	 */
	EList<spem.uma.Process> getRelatedWorflow();
