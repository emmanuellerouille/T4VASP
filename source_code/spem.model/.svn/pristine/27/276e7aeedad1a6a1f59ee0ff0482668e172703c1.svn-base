 ...
 * <ul>
 *   <li>{@link spem.impl.WorkSequenceImpl#getLinkKind <em>Link Kind</em>}</li>
 *   <li>{@link spem.impl.WorkSequenceImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link spem.impl.WorkSequenceImpl#getSuccessor <em>Successor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
