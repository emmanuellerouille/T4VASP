 ...
 * <ul>
 *   <li>{@link spem.impl.ProcessComponentUseImpl#getProcessComponent <em>Process Component</em>}</li>
 *   <li>{@link spem.impl.ProcessComponentUseImpl#getUsedPort <em>Used Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
