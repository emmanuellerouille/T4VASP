 ...
 * <ul>
 *   <li>{@link spem.impl.WorkBreakdownElementImpl#isIsRepeatable <em>Is Repeatable</em>}</li>
 *   <li>{@link spem.impl.WorkBreakdownElementImpl#isIsOngoing <em>Is Ongoing</em>}</li>
 *   <li>{@link spem.impl.WorkBreakdownElementImpl#isIsEventDriven <em>Is Event Driven</em>}</li>
 *   <li>{@link spem.impl.WorkBreakdownElementImpl#getLinkToPredecessor <em>Link To Predecessor</em>}</li>
 *   <li>{@link spem.impl.WorkBreakdownElementImpl#getLinkToSuccessor <em>Link To Successor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
