 ...
 * <ul>
 *   <li>{@link spem.uma.impl.ProcessImpl#getIncludedPattern <em>Included Pattern</em>}</li>
 *   <li>{@link spem.uma.impl.ProcessImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link spem.uma.impl.ProcessImpl#getUsageNote <em>Usage Note</em>}</li>
 *   <li>{@link spem.uma.impl.ProcessImpl#getIncludedConnector <em>Included Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProcessImpl extends ActivityImpl implements spem.uma.Process {
	/**
