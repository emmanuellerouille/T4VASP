...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.ObjectHandle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectHandleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectHandle_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectHandle_object_feature", "_UI_ObjectHandle_type"),
				 VariabilityPackage.Literals.OBJECT_HANDLE__OBJECT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectHandle_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectHandle_ref_feature", "_UI_ObjectHandle_type"),
				 VariabilityPackage.Literals.OBJECT_HANDLE__REF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ObjectHandle)object).getName();
