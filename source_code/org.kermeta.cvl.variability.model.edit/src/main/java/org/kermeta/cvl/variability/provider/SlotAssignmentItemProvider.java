...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.SlotAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotAssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VariabilityPackage.Literals.SLOT_ASSIGNMENT__SLOT_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VariabilityPackage.Literals.SLOT_ASSIGNMENT__VALUE);
			childrenFeatures.add(VariabilityPackage.Literals.SLOT_ASSIGNMENT__SLOT_OWNER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.SLOT_ASSIGNMENT__VALUE,
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.SLOT_ASSIGNMENT__SLOT_OWNER,
