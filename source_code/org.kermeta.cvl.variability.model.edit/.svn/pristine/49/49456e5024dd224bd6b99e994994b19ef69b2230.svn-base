...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.ParametricSlotAssignmet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParametricSlotAssignmetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VariabilityPackage.Literals.PARAMETRIC_SLOT_ASSIGNMET__SLOT_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VariabilityPackage.Literals.PARAMETRIC_SLOT_ASSIGNMET__SLOT_OWNER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.PARAMETRIC_SLOT_ASSIGNMET__SLOT_OWNER,
