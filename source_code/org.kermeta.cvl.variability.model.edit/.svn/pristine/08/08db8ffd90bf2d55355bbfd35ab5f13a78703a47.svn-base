...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.CompositeVariationPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeVariationPointItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VariabilityPackage.Literals.COMPOSITE_VARIATION_POINT__BINDING_CV_SPEC,
				 true,
				 false,
				 true,
				 null,
