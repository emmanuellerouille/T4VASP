...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.VSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VSpecItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VariabilityPackage.Literals.VSPEC__RESOLUTION_TIME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VariabilityPackage.Literals.VSPEC__GROUP_MULTIPLICITY);
			childrenFeatures.add(VariabilityPackage.Literals.VSPEC__CHILD_VSPEC);
			childrenFeatures.add(VariabilityPackage.Literals.VSPEC__DERIVATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VSPEC__GROUP_MULTIPLICITY,
				 VariabilityFactory.eINSTANCE.createMultiplicityInterval()));

		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VSPEC__CHILD_VSPEC,
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VSPEC__DERIVATION,
				 VariabilityFactory.eINSTANCE.createVSpecDerivation()));

		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VSPEC__DERIVATION,
				 VariabilityFactory.eINSTANCE.createChoiceDerivation()));

		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VSPEC__DERIVATION,
				 VariabilityFactory.eINSTANCE.createVariableDerivation()));

		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VSPEC__DERIVATION,
				 VariabilityFactory.eINSTANCE.createCVSpecDerivation()));
	}
