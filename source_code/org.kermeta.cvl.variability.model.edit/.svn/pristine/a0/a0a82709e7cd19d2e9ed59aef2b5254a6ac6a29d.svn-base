...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.VariationPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VariabilityPackage.Literals.VARIATION_POINT__BINDING_VSPEC,
				 true,
				 false,
				 true,
				 null,
