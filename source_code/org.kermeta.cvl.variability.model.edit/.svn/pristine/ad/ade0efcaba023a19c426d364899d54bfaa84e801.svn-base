...
/**
 * This is the item provider adapter for a {@link org.kermeta.cvl.variability.ValueSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueSpecificationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VariabilityPackage.Literals.VALUE_SPECIFICATION__TYPE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ValueSpecification.class)) {
			case VariabilityPackage.VALUE_SPECIFICATION__TYPE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VALUE_SPECIFICATION__TYPE,
				 VariabilityFactory.eINSTANCE.createVariabletype()));
		...
		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VALUE_SPECIFICATION__TYPE,
				 VariabilityFactory.eINSTANCE.createPrimitveType()));

		newChildDescriptors.add
			(createChildParameter
				(VariabilityPackage.Literals.VALUE_SPECIFICATION__TYPE,
				 VariabilityFactory.eINSTANCE.createObjectType()));
	}
