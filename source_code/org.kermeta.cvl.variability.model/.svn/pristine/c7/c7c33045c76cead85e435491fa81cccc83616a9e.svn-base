 ...
 * <ul>
 *   <li>{@link org.kermeta.cvl.variability.impl.VPackageImpl#getPackageElement <em>Package Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VPackageImpl extends VPackageableImpl implements VPackage {
	...
	protected EClass eStaticClass() {
		return VariabilityPackage.Literals.VPACKAGE;
	}
	...
	public EList<VPackageable> getPackageElement() {
		if (packageElement == null) {
			packageElement = new EObjectContainmentEList<VPackageable>(VPackageable.class, this, VariabilityPackage.VPACKAGE__PACKAGE_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case VariabilityPackage.VPACKAGE__PACKAGE_ELEMENT:
