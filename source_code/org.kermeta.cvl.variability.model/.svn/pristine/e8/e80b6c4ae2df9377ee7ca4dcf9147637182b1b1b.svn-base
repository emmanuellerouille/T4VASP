 ...
 * <!-- end-user-doc -->
 * @see org.kermeta.cvl.variability.VariabilityPackage#getLogicalOp()
 * @model
 * @generated
 */
public enum LogicalOp implements Enumerator {
	...
	/**
	 * The '<em><b>Implies Else</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #IMPLIES_ELSE_VALUE
	 * @generated
	 * @ordered
	 */
	IMPLIES_ELSE(6, "ImpliesElse", "ImpliesElse");
	...
	/**
	 * The '<em><b>Implies Else</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Implies Else</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #IMPLIES_ELSE
	 * @model name="ImpliesElse"
	 * @generated
	 * @ordered
	 */
	public static final int IMPLIES_ELSE_VALUE = 6;
	...
	public static LogicalOp get(int value) {
		switch (value) {
			...
			case IMPLIES_ELSE_VALUE: return IMPLIES_ELSE;
		}
		return null;
	}
