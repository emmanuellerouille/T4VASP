 ...
 * <ul>
 *   <li>{@link org.kermeta.cvl.variability.impl.LinkAssignmentImpl#getLink <em>Link</em>}</li>
 *   <li>{@link org.kermeta.cvl.variability.impl.LinkAssignmentImpl#getLinkEndIdentifier <em>Link End Identifier</em>}</li>
 *   <li>{@link org.kermeta.cvl.variability.impl.LinkAssignmentImpl#getNewEnd <em>New End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkAssignmentImpl extends ChoiceVariationPointImpl implements LinkAssignment {
	...
	protected EClass eStaticClass() {
		return VariabilityPackage.Literals.LINK_ASSIGNMENT;
	}
	...
	public NotificationChain basicSetLink(LinkHandle newLink, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VariabilityPackage.LINK_ASSIGNMENT__LINK, oldLink, newLink);
	...
	public void setLink(LinkHandle newLink) {
		if (newLink != link) {
			...
			if (link != null)
				msgs = ((InternalEObject)link).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VariabilityPackage.LINK_ASSIGNMENT__LINK, null, msgs);
			if (newLink != null)
				msgs = ((InternalEObject)newLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VariabilityPackage.LINK_ASSIGNMENT__LINK, null, msgs);
			msgs = basicSetLink(newLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariabilityPackage.LINK_ASSIGNMENT__LINK, newLink, newLink));
	}
	...
	public void setLinkEndIdentifier(String newLinkEndIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariabilityPackage.LINK_ASSIGNMENT__LINK_END_IDENTIFIER, oldLinkEndIdentifier, linkEndIdentifier));
	}
	...
	public NotificationChain basicSetNewEnd(ObjectHandle newNewEnd, NotificationChain msgs) {
		...
		newEnd = newNewEnd;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VariabilityPackage.LINK_ASSIGNMENT__NEW_END, oldNewEnd, newNewEnd);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNewEnd(ObjectHandle newNewEnd) {
		if (newNewEnd != newEnd) {
			NotificationChain msgs = null;
			if (newEnd != null)
				msgs = ((InternalEObject)newEnd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VariabilityPackage.LINK_ASSIGNMENT__NEW_END, null, msgs);
			if (newNewEnd != null)
				msgs = ((InternalEObject)newNewEnd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VariabilityPackage.LINK_ASSIGNMENT__NEW_END, null, msgs);
			msgs = basicSetNewEnd(newNewEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariabilityPackage.LINK_ASSIGNMENT__NEW_END, newNewEnd, newNewEnd));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case VariabilityPackage.LINK_ASSIGNMENT__LINK:
				return basicSetLink(null, msgs);
			case VariabilityPackage.LINK_ASSIGNMENT__NEW_END:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VariabilityPackage.LINK_ASSIGNMENT__LINK:
				return getLink();
			case VariabilityPackage.LINK_ASSIGNMENT__LINK_END_IDENTIFIER:
