 ...
 * <ul>
 *   <li>{@link org.kermeta.cvl.variability.impl.PlacementFragmentImpl#getPlacementBoundaryElement <em>Placement Boundary Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlacementFragmentImpl extends VariationPointImpl implements PlacementFragment {
	...
	protected EClass eStaticClass() {
		return VariabilityPackage.Literals.PLACEMENT_FRAGMENT;
	}
	...
	public EList<PlacementBoundaryElement> getPlacementBoundaryElement() {
		if (placementBoundaryElement == null) {
			placementBoundaryElement = new EObjectContainmentEList<PlacementBoundaryElement>(PlacementBoundaryElement.class, this, VariabilityPackage.PLACEMENT_FRAGMENT__PLACEMENT_BOUNDARY_ELEMENT);
		}
