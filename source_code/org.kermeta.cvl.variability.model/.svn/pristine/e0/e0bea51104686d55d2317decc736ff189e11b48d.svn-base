 ...
 * <ul>
 *   <li>{@link org.kermeta.cvl.variability.impl.ChoiceImpl#isDefaultResolution <em>Default Resolution</em>}</li>
 *   <li>{@link org.kermeta.cvl.variability.impl.ChoiceImpl#isIsImpliedByParent <em>Is Implied By Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceImpl extends VSpecImpl implements Choice {
	...
	protected EClass eStaticClass() {
		return VariabilityPackage.Literals.CHOICE;
	}
	...
	public void setDefaultResolution(boolean newDefaultResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariabilityPackage.CHOICE__DEFAULT_RESOLUTION, oldDefaultResolution, defaultResolution));
	}
	...
	public void setIsImpliedByParent(boolean newIsImpliedByParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariabilityPackage.CHOICE__IS_IMPLIED_BY_PARENT, oldIsImpliedByParent, isImpliedByParent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VariabilityPackage.CHOICE__DEFAULT_RESOLUTION:
				return isDefaultResolution();
			case VariabilityPackage.CHOICE__IS_IMPLIED_BY_PARENT:
