 ...
 * <ul>
 *   <li>{@link org.kermeta.cvl.variability.impl.CVSpecDerivationImpl#getMemberDerivation <em>Member Derivation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CVSpecDerivationImpl extends VSpecDerivationImpl implements CVSpecDerivation {
	...
	protected EClass eStaticClass() {
		return VariabilityPackage.Literals.CV_SPEC_DERIVATION;
	}
	...
	public EList<VSpecDerivation> getMemberDerivation() {
		if (memberDerivation == null) {
			memberDerivation = new EObjectContainmentEList<VSpecDerivation>(VSpecDerivation.class, this, VariabilityPackage.CV_SPEC_DERIVATION__MEMBER_DERIVATION);
		}
