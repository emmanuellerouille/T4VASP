 ...
 * <ul>
 *   <li>{@link org.kermeta.cvl.variability.impl.PrimitveTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimitveTypeImpl extends VariabletypeImpl implements PrimitveType {
	...
	protected EClass eStaticClass() {
		return VariabilityPackage.Literals.PRIMITVE_TYPE;
	}
	...
	public void setType(PrimitiveTypeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariabilityPackage.PRIMITVE_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VariabilityPackage.PRIMITVE_TYPE__TYPE:
				return getType();
		}
