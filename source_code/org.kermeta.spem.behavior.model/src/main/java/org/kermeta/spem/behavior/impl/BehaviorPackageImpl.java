...
public class BehaviorPackageImpl extends EPackageImpl implements BehaviorPackage {
	 ...
	 * @generated
	 */
	public EReference getWorkUnitHandle_WorkUnit() {
		return (EReference)workUnitHandleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWorkUnitHandle_ManualInitialization() {
		return (EAttribute)workUnitHandleEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWorkUnitHandle_ManualFinalization() {
		return (EAttribute)workUnitHandleEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workUnitHandleEClass, WORK_UNIT_HANDLE__WORK_UNIT);
		...
		createEAttribute(workUnitHandleEClass, WORK_UNIT_HANDLE__MANUAL_INITIALIZATION);
		createEAttribute(workUnitHandleEClass, WORK_UNIT_HANDLE__MANUAL_FINALIZATION);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkUnitHandle_WorkUnit(), ecorePackage.getEObject(), null, "workUnit", null, 1, 1, WorkUnitHandle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWorkUnitHandle_ManualInitialization(), ecorePackage.getEBoolean(), "manualInitialization", null, 0, 1, WorkUnitHandle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWorkUnitHandle_ManualFinalization(), ecorePackage.getEBoolean(), "manualFinalization", null, 0, 1, WorkUnitHandle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
