 ...
 *   <li>{@link org.kermeta.spem.behavior.impl.PreConditionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PreConditionImpl extends EObjectImpl implements PreCondition {
	...
	public Expression getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviorPackage.PRE_CONDITION__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(Expression newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.PRE_CONDITION__EXPRESSION, oldExpression, expression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviorPackage.PRE_CONDITION__NAME:
				return getName();
			case BehaviorPackage.PRE_CONDITION__EXPRESSION:
