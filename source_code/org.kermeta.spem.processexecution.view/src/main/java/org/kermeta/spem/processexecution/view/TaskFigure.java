...
public class TaskFigure extends RectangleFigure implements ActionContainer {
	...
	public IFigure getActionsPlate() {
		return actionsPlate;
	}

	public void setActionsPlate(IFigure actionsPlate) {
		this.actionsPlate = actionsPlate;
	}

	public IFigure getStdActionsPlate() {
		return stdActionsPlate;
	}

	public void setStdActionsPlate(IFigure stdActionsPlate) {
		this.stdActionsPlate = stdActionsPlate;
	}
